...
public class MultipleElements {
    ...
    WebDriver driver;
    @Test
    public void verifyNumberOfElementsAdded() throws InterruptedException {
        ...
        WebElement addElement= driver.findElement(By.cssSelector(".example>button"));//. is class is css selector
