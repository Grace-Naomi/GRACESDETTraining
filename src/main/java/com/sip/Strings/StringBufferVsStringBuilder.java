...
public class StringBufferVsStringBuilder {
    public static void main(String[] args){
        StringBuffer stringBuffer=new StringBuffer("Slenium");
        ...
        System.out.println(sb.compareTo(sb1));//if both strings are equal it returns zero '0'
        System.out.println(sb.compareTo(sb2));//if both strings are not equal it returns negative value
